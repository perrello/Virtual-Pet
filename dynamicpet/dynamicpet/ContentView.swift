...
private extension ContentView {
    ...
    func installTapped() {
        ...
        Task {
            ...
            do {
                ...
                PackManager.setActive(meta: meta)
                
                //TODO double wait? gatver
                PetActivity.start(fps: meta.fps, mood: "Excited") //TODO game logic
    ...
    func setActive(_ id: String) {
        ...
        PetActivity.start(fps: meta.fps, mood: "Excited") //TODO mood manager / game manager etc
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.15) {
            PetActivity.refresh()
        }
    }
